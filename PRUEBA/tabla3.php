...
<body>
        ...
        <header>
              ...
              <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
                <ul class="nav nav-pills flex-column mb-auto"  id="sideBarcollapse">
                    ...
                    <br>
                    <li>
                    <a href="#cars"><img src="img/Mi proyecto.png" width= 25px height=25px>Autos</a>
                    </li>
                    <br>
                    <br>
                    <li>
    ...
    <br>
        ...
        <div class="tabla3" style="width: 80%;margin-left: 20%;" id="cars">
            <h2 style= "font-family: 'Raleway','sans-serif'; color: dodgerblue" align="left">Autos</h2>
            <br>
            <table class="table table-responsive" align="center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $row['autos_id']; ?> </td>
                        <td><?php echo $row['tipo']; ?></td>
                        <td><?php echo $row['modelo']; ?></td>
                        <td><?php echo $row['patente']; ?></td>
                        <td><a href=""><button class="btn btn-danger" type="submit" name="enviar" id="enviar">Eliminar</button></td></a>
