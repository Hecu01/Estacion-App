...
<body onload = "habilitar()">
    ...
    <div class="contenedor-general">
        ...
        <div class="contenedor-registro">
            ...
            <form action="registrar.php" name="form" id= "form" method="POST" align="center" autocomplete="on" >
                ...
                <input type="submit" name= "boton_enviar" id="boton_enviar" style="display: block; margin: auto;" onclick="miAlerta()" class="btn btn-primary" value="Enviar" > 
...
boton = document.getElementByid('boton_enviar');
